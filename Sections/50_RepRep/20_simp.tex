...
If there are two irreducible representations $\rho: G \to V$ and $\rho': G \to V'$ of a group $G$ and $f: V \to V'$ is an intertwiner (see \Cref{sec:basics.equ} for the definition) of these representations, then the following statements are true.
\begin{enumerate}

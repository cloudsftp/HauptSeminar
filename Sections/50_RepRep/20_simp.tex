...
\todo[inline]{look at definition of rho' again (rho'a = rhoa?)}
...
\todo[inline]{only existance of the decomposition from above fact}
...
\todo[inline]{proof of lemma}

\todo[inline]{decomposition from above is \textit{unique}}

\todo[inline]{proof \# conj = \# inequivalent irr rep}

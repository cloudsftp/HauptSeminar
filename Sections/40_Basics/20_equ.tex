...
A map $f: V \to V'$ is an intertwiner of two representations $\rho: G \to V$ and $\rho': G \to V'$ of a group $G$, iff the diagram in \Cref{fig:main.what.equ-cd} commutes\cite{fuchs2003}.

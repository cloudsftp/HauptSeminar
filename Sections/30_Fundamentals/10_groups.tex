...
%\todo[inline]{remove topological group?}
...
%This is the case, if and only if the map $m: G \times G \to G: (x, y) \mapsto xy^{-1}$ is continuous.
%$m$ is continuous, if and only if for all $x, y \in G$ and any neighbourhood $W$ of $xy^{-1}$ there are neighbourhoods $U$ of $x$ and $V$ of $y$, such that $U \cdot V^{-1} \subseteq W$.
...
\todo[inline]{all elements of finite groups have finite order}
